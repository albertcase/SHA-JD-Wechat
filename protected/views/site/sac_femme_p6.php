    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/sac_femme_pro/mario1.jpg" width="100%" />
            </div>
            <div class="swiper-slide">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/sac_femme_pro/mario2.jpg" width="100%"/>
            </div>
            <div class="swiper-slide">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/sac_femme_pro/mario3.jpg" width="100%"/>
            </div>
        </div>
   ...
   <!--  <div class="btn-wishlist">
    ...
    <div class="tab">
        ...
        <div class="con1">
            <ul>    
                <li>
                    特点：Mario黑色泡泡羔羊皮包是一款全新的背包式手袋，大量的流苏设计流露波西米亚的灵魂。Mario 每天都散发酷我的生活态度。<br/>
...
<script>
    var mySound = new buzz.sound( "<?php echo Yii::app()->request->baseUrl; ?>/sound/Femme/Mario", {
    formats: [  "mp3" ]
});
